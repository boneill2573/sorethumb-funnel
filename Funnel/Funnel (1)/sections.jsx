...
function ScarcityBar({ spots, total }) {
  const message = (
    <span className="scarcity-msg">
      ...
      ONLY <strong>{spots} OF {total}</strong> BROKERAGE SLOTS LEFT THIS MONTH
    ...
    <header className="topbar">
      <div className="topbar-inner">
        ...
        <div className="topbar-meta">
          ...
          <span>SYSTEM ACTIVE · ONBOARDING 6 BROKERAGES THIS MONTH</span>
        </div>
    ...
    <section className="hero">
      <div className="hero-grid">
        <div className="hero-head">
          ...
          {variant === 'system' &&
          <h1>
              <span className="text-grad">17–48 exclusive mortgage leads</span>
              <br />
              <span className="accent">every week.</span>
              <br />
              <span className="text-grad" style={{ fontSize: '0.7em', fontWeight: 800 }}>Without expensive lead vendors, shared data, or referral roulette.</span>
            </h1>
          }
          ...
          <h1>
              ...
              <br />
              <span className="accent">Start owning your pipeline.</span>
              <br />
              <span className="text-grad" style={{ fontSize: '0.7em', fontWeight: 800 }}>100 exclusive leads in 90 days — installed in 7.</span>
            </h1>
          }
        ...
        <div className="hero-ribbon">
          ...
          <div className="hero-ribbon-cell">
            ...
            <span className="label">Largest loan closed</span>
          </div>
          <div className="hero-ribbon-cell">
    ...
    <section className="section" id="results">
      <div className="container">
        <div className="section-head center">
          ...
          <h2 className="text-grad">Real brokerages. Real revenue. Real receipts.</h2>
          <p className="lede">Not vanity numbers. Not screenshots from 2019. These are brokerages running our Built to Scale™ system right now.</p>
        </div>
        ...
        <div className="case-grid">
          ...
          <div className="case-card">
            <div>
              <div className="case-label">DECEMBER · MORTGAGE BROKERAGE</div>
          ...
          <div className="case-card">
            <div>
              ...
              <div style={{ fontSize: 16, color: 'var(--text-mute)', marginTop: 4 }}>loan closed without manual prospecting.</div>
            </div>
            <div className="case-meta">
          ...
          <div className="case-card">
            <div>
              <div className="case-label">ANDREW · FIRST CLOSING</div>
    ...
    <section className="section" id="problem">
      <div className="container">
        <div className="section-head">
          ...
          <p className="lede">Behind closed doors, a small group of brokerages are replacing fragility before it becomes visible. They don't buy leads. They engineer pipelines. Here's the split.</p>
        </div>
        ...
        <div className="compare-grid">
          <div className="compare-card compare-card--bad">
            ...
            <ul className="compare-list">
              <li><span className="icon"><Icon.X /></span>Expensive lead vendors selling the same data to 5 other LOs</li>
              <li><span className="icon"><Icon.X /></span>Generic creatives stuck on stock photos and tired hooks</li>
              <li><span className="icon"><Icon.X /></span>Loan officers wasting hours on manual follow-up of dead leads</li>
              <li><span className="icon"><Icon.X /></span>One-size-fits-all strategy from a vendor with 200 other clients</li>
              <li><span className="icon"><Icon.X /></span>An inconsistent pipeline that lives and dies on referrals</li>
          ...
          <div className="compare-card compare-card--good">
            ...
            <ul className="compare-list">
              <li><span className="icon"><Icon.Check /></span>Exclusive inbound at brokerage level — leads only you get</li>
              <li><span className="icon"><Icon.Check /></span>AI-generated creatives, hyper-targeted, refreshed continuously</li>
              <li><span className="icon"><Icon.Check /></span>Automated SMS + email nurture — LOs only talk to qualified borrowers</li>
              <li><span className="icon"><Icon.Check /></span>One channel mastered, then stacked. Built specifically for mortgage.</li>
...
{ icon: <Icon.Sparkle />, title: 'Offer Crafting', body: 'Mortgages aren\'t sexy. Outcomes are. We position the keys, the savings, and the certainty — not loans and rates.' },
...
{ icon: <Icon.Funnel />, title: 'Lead Qualification', body: 'You define qualified. We build the funnel that filters tire-kickers before they ever hit your LOs\' calendars.' },
...
{ icon: <Icon.Loop />, title: 'Feedback Loops', body: '20 leads → 10 applications → 4 close. We feed those 4 back into targeting. CPL drops while volume rises. Every month.' },
{ icon: <Icon.Chart />, title: 'Live Tracking', body: '24/7 real-time dashboards. Cost per lead, lead-to-application ratio, ROI, conversions. Every metric. No waiting.' },
    ...
    <section className="section" id="system">
      <div className="container">
        <div className="section-head center">
          ...
          <p className="lede">No black box. No vendor lock-in. The full infrastructure your brokerage should've had from day one.</p>
        </div>
        ...
        <div style={{ marginTop: 40, display: 'flex', justifyContent: 'center' }}>
          <button className="btn btn-primary btn-lg" onClick={onApply}>
            See how we'd install this for your brokerage
            <span className="arrow"><Icon.Arrow /></span>
          </button>
        </div>
      </div>
    ...
    <section className="section" id="testimonials">
      <div className="container">
        <div className="section-head center">
          ...
          <h2 className="text-grad">Real brokerages. Real feedback. No scripts.</h2>
        </div>
    ...
    <section className="section" id="qualify">
      <div className="container">
        <div className="section-head center">
          ...
          <h2 className="text-grad">Built for a specific kind of brokerage.</h2>
        ...
        <div className="qualify-grid">
          <div className="qualify-card is-yes">
            ...
            <ul>
              <li><span className="icon"><Icon.Check /></span>You run an established brokerage doing <strong>$500K+ in commission revenue</strong> (not funded volume)</li>
              <li><span className="icon"><Icon.Check /></span>You're tired of expensive lead vendors and rising CPLs</li>
...
const FAQS = [
{ q: 'What happens on the diagnostic call?', a: 'We walk through your current lead-gen setup — what you\'re running, what it costs, how many leads you\'re getting, and what conversion looks like from lead to application to close. Then we identify the gaps and show you exactly what we\'d build. If we can\'t help, we tell you fast.' },
{ q: 'Will this disrupt our current operations?', a: 'No. We integrate with your existing setup and handle the buildout behind the scenes. You provide access to ad accounts and lead tracking — we don\'t require you to pause campaigns or overhaul your process. Most brokerages are up and running within 7 days.' },
{ q: 'How quickly will we see results?', a: 'Most brokerages see improved cost per lead and lead quality within the first 30–45 days. Significant pipeline impact — $60K+ added in commission — typically happens within 60–90 days. The system compounds over time as the optimization feedback loop runs.' },
{ q: 'How is this different from shared lead vendors?', a: 'Shared vendors sell the same lead to 5 or 6 LOs. You\'re competing for attention, and half the time the borrower has already locked with someone else. We build you exclusive inbound — leads are yours alone, targeted to active purchase and refi prospects. No competition. Higher pick-up. Better close rates. One brokerage per territory.' },
{ q: 'What do we need to provide on our end?', a: 'Access to ad accounts, CRM/LOS, and lead tracking so we can set up proper measurement. Someone available for the weekly check-in call. That\'s it. We handle strategy, execution, tracking, optimization, and reporting.' },
{ q: 'How do you ensure the leads are qualified?', a: 'You define what "qualified" means for your brokerage — credit band, loan size, intent, timeline. We build the pre-qualification process into the funnel so tire-kickers get filtered out before they ever hit an LO. Only the right borrowers make it through.' },
{ q: 'What results can we realistically expect?', a: 'Brokerages running Built to Scale™ typically see CPL drop from $30–$50 to $4–$12 within 60–90 days. Lead-to-application ratios improve to 25–35%. Commission adds of $60K–$240K in the first 90 days are common. Volume increases 50–87% while CPL drops 40–65%.' },
